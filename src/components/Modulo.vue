  ...
  <div class="modulo">
    <template>
      ...
      <b-container>
        ...
        <b-button variant="success" to="/modulos/nuevo">Nuevo Modulo</b-button></b-row><br>
      <b-table fixed bordered hover :items="modulos" :fields="fields" head-variant="dark" class="text-center">
